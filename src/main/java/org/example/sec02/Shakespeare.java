...
public class Shakespeare {
    public static void main(String[] args) throws IOException {
        ...
        Set<String> shakespeareWords = Files.lines(Paths.get("src/main/resources/files.sec02/words.shakespeare.txt"))
                .map(String::toLowerCase)
                .collect(Collectors.toSet());

        Set<String> scrabbleWords = Files.lines(Paths.get("src/main/resources/files.sec02//ospd.txt"))
                .map(String::toLowerCase)
                .collect(Collectors.toSet());
